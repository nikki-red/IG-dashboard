...
const Team5_EC2InsightsComponent = () => {
    ...
    useEffect(() => {
        ...
        const fetchEc2Insights = async () => {
            ...
            try {
                const response = await fetch('https://rcrf0s9sb7.execute-api.us-east-1.amazonaws.com/default/y_ig_insights_1');
...
export default Team5_EC2InsightsComponent;
